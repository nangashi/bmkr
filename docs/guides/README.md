...
- **設計レビュー時** (issue-implement Phase 1): `implementation-anti-patterns.md` を参照
- **I/F設計時** (issue-implement Phase 1): `codegen-workflow.md` を参照
- **実装時** (issue-implement Phase 3): `go-logging.md`, `implementation-anti-patterns.md` を参照
- **最終レビュー時** (issue-implement Phase 3 品質ゲート): `implementation-anti-patterns.md`, `testing-strategy.md` を参照
