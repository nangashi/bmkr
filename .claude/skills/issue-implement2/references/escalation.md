...
| `test_fix` | Opus がテストを修正し、Red レビューを再実行する |
| `stop_and_report` | 現在の best state で停止し、ユーザーに報告する |

## 証拠要件

Escalation で契約またはテストを修正する場合、以下を必ず `.output/issue-implement2/{issue_number}/escalation.md` に記録する:
